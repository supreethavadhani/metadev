 ...
 */ 
public class TrustData extends SchemaData {

	protected TrustData(final Trust schema, final Object[] data) {
		super(schema, data);
	}
	...
	/**
	 * set value for accountStatus
	 * @param value to be assigned to accountStatus
	 */
