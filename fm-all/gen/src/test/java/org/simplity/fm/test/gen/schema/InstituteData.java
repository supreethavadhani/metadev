...
public class InstituteData extends SchemaData {
	...
	protected InstituteData(final Institute schema, final Object[] data) {
		super(schema, data);
	}
	...
	/**
	 * set value for isInactive
	 * @param value to be assigned to isInactive
	 */
